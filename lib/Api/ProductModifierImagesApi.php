...
class ProductModifierImagesApi
{
     ...
     * @param  \SplFileObject $image_file image_file (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ImageResponse
     */
    public function createModifierImage($product_id, $modifier_id, $value_id, $accept, $content_type, $image_file = null)
    {
        list($response) = $this->createModifierImageWithHttpInfo($product_id, $modifier_id, $value_id, $accept, $content_type, $image_file);
        return $response;
    }
     ...
     * @param  \SplFileObject $image_file (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ImageResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createModifierImageWithHttpInfo($product_id, $modifier_id, $value_id, $accept, $content_type, $image_file = null)
    {
        $returnType = '\Swagger\Client\Model\ImageResponse';
        $request = $this->createModifierImageRequest($product_id, $modifier_id, $value_id, $accept, $content_type, $image_file);
     ...
     */
    public function createModifierImageAsync($product_id, $modifier_id, $value_id, $accept, $content_type, $image_file = null)
    {
        return $this->createModifierImageAsyncWithHttpInfo($product_id, $modifier_id, $value_id, $accept, $content_type, $image_file)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createModifierImageAsyncWithHttpInfo($product_id, $modifier_id, $value_id, $accept, $content_type, $image_file = null)
    {
        $returnType = '\Swagger\Client\Model\ImageResponse';
        $request = $this->createModifierImageRequest($product_id, $modifier_id, $value_id, $accept, $content_type, $image_file);
     ...
     */
    protected function createModifierImageRequest($product_id, $modifier_id, $value_id, $accept, $content_type, $image_file = null)
    {
