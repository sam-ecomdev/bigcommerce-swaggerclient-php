...
class ProductBulkPricingRulesApi
{
     ...
     * @param  \Swagger\Client\Model\BulkPricingRuleFull $bulk_pricing_rule bulk_pricing_rule (required)
     ...
     */
    public function createBulkPricingRule($product_id, $bulk_pricing_rule, $accept, $content_type, $page = null, $limit = null)
    {
        list($response) = $this->createBulkPricingRuleWithHttpInfo($product_id, $bulk_pricing_rule, $accept, $content_type, $page, $limit);
        return $response;
    }
     ...
     *
     * @param  int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param  \Swagger\Client\Model\BulkPricingRuleFull $bulk_pricing_rule (required)
     ...
     */
    public function createBulkPricingRuleWithHttpInfo($product_id, $bulk_pricing_rule, $accept, $content_type, $page = null, $limit = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2006';
        $request = $this->createBulkPricingRuleRequest($product_id, $bulk_pricing_rule, $accept, $content_type, $page, $limit);
     ...
     */
    public function createBulkPricingRuleAsync($product_id, $bulk_pricing_rule, $accept, $content_type, $page = null, $limit = null)
    {
        return $this->createBulkPricingRuleAsyncWithHttpInfo($product_id, $bulk_pricing_rule, $accept, $content_type, $page, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createBulkPricingRuleAsyncWithHttpInfo($product_id, $bulk_pricing_rule, $accept, $content_type, $page = null, $limit = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2006';
        $request = $this->createBulkPricingRuleRequest($product_id, $bulk_pricing_rule, $accept, $content_type, $page, $limit);
     ...
     */
    protected function createBulkPricingRuleRequest($product_id, $bulk_pricing_rule, $accept, $content_type, $page = null, $limit = null)
    {
     ...
     */
    public function updateBulkPricingRule($product_id, $bulk_pricing_rule_id, $bulk_pricing_rule, $accept, $content_type)
    {
        list($response) = $this->updateBulkPricingRuleWithHttpInfo($product_id, $bulk_pricing_rule_id, $bulk_pricing_rule, $accept, $content_type);
        return $response;
    }
     ...
     */
    public function updateBulkPricingRuleWithHttpInfo($product_id, $bulk_pricing_rule_id, $bulk_pricing_rule, $accept, $content_type)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2007';
        $request = $this->updateBulkPricingRuleRequest($product_id, $bulk_pricing_rule_id, $bulk_pricing_rule, $accept, $content_type);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateBulkPricingRuleAsync($product_id, $bulk_pricing_rule_id, $bulk_pricing_rule, $accept, $content_type)
    {
        return $this->updateBulkPricingRuleAsyncWithHttpInfo($product_id, $bulk_pricing_rule_id, $bulk_pricing_rule, $accept, $content_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateBulkPricingRuleAsyncWithHttpInfo($product_id, $bulk_pricing_rule_id, $bulk_pricing_rule, $accept, $content_type)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2007';
        $request = $this->updateBulkPricingRuleRequest($product_id, $bulk_pricing_rule_id, $bulk_pricing_rule, $accept, $content_type);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateBulkPricingRuleRequest($product_id, $bulk_pricing_rule_id, $bulk_pricing_rule, $accept, $content_type)
    {
        // verify the required parameter 'product_id' is set
        if ($product_id === null || (is_array($product_id) && count($product_id) === 0)) {
            throw new \InvalidArgumentException(
