...
class BrandsApi
{
     ...
     * Create a Brand
     *
     * @param  \Swagger\Client\Model\Brand $brand brand (required)
     * @param  string $accept accept (required)
     * @param  string $content_type content_type (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\BrandResponse
     */
    public function createBrand($brand, $accept, $content_type)
    {
        list($response) = $this->createBrandWithHttpInfo($brand, $accept, $content_type);
        return $response;
    }
     ...
     * Create a Brand
     *
     * @param  \Swagger\Client\Model\Brand $brand (required)
     * @param  string $accept (required)
     * @param  string $content_type (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\BrandResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createBrandWithHttpInfo($brand, $accept, $content_type)
    {
        $returnType = '\Swagger\Client\Model\BrandResponse';
        $request = $this->createBrandRequest($brand, $accept, $content_type);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\BrandResponse',
     ...
     */
    public function createBrandAsync($brand, $accept, $content_type)
    {
        return $this->createBrandAsyncWithHttpInfo($brand, $accept, $content_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createBrandAsyncWithHttpInfo($brand, $accept, $content_type)
    {
        $returnType = '\Swagger\Client\Model\BrandResponse';
        $request = $this->createBrandRequest($brand, $accept, $content_type);
     ...
     */
    protected function createBrandRequest($brand, $accept, $content_type)
    {
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\BrandResponse1
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\BrandResponse1, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBrandByIdWithHttpInfo($brand_id, $content_type, $accept, $include_fields = null, $exclude_fields = null)
    {
        $returnType = '\Swagger\Client\Model\BrandResponse1';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\BrandResponse1',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\BrandCollectionResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\BrandCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Swagger\Client\Model\BrandCollectionResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\BrandCollectionResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $brand_id The ID of the &#x60;Brand&#x60; to which the resource belongs. (required)
     * @param  \Swagger\Client\Model\Brand2 $brand brand (required)
     * @param  string $content_type content_type (required)
     * @param  string $accept accept (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     ...
     * @return \Swagger\Client\Model\BrandResponse
     */
    public function updateBrand($brand_id, $brand, $content_type, $accept)
    {
        list($response) = $this->updateBrandWithHttpInfo($brand_id, $brand, $content_type, $accept);
        return $response;
    }
     ...
     *
     * @param  int $brand_id The ID of the &#x60;Brand&#x60; to which the resource belongs. (required)
     * @param  \Swagger\Client\Model\Brand2 $brand (required)
     * @param  string $content_type (required)
     * @param  string $accept (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     ...
     * @return array of \Swagger\Client\Model\BrandResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateBrandWithHttpInfo($brand_id, $brand, $content_type, $accept)
    {
        $returnType = '\Swagger\Client\Model\BrandResponse';
        $request = $this->updateBrandRequest($brand_id, $brand, $content_type, $accept);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateBrandAsync($brand_id, $brand, $content_type, $accept)
    {
        return $this->updateBrandAsyncWithHttpInfo($brand_id, $brand, $content_type, $accept)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateBrandAsyncWithHttpInfo($brand_id, $brand, $content_type, $accept)
    {
        $returnType = '\Swagger\Client\Model\BrandResponse';
        $request = $this->updateBrandRequest($brand_id, $brand, $content_type, $accept);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateBrandRequest($brand_id, $brand, $content_type, $accept)
    {
        // verify the required parameter 'brand_id' is set
        if ($brand_id === null || (is_array($brand_id) && count($brand_id) === 0)) {
            throw new \InvalidArgumentException(
