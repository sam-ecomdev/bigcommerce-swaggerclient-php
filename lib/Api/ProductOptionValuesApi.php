...
class ProductOptionValuesApi
{
     ...
     * @param  object $option_value option_value (required)
     ...
     */
    public function createOptionValue($product_id, $option_id, $option_value, $accept, $content_type)
    {
        list($response) = $this->createOptionValueWithHttpInfo($product_id, $option_id, $option_value, $accept, $content_type);
        return $response;
    }
     ...
     * @param  int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param  int $option_id The ID of the &#x60;Option&#x60;. (required)
     * @param  object $option_value (required)
     ...
     */
    public function createOptionValueWithHttpInfo($product_id, $option_id, $option_value, $accept, $content_type)
    {
        $returnType = '\Swagger\Client\Model\VariantResponse';
        $request = $this->createOptionValueRequest($product_id, $option_id, $option_value, $accept, $content_type);
     ...
     */
    public function createOptionValueAsync($product_id, $option_id, $option_value, $accept, $content_type)
    {
        return $this->createOptionValueAsyncWithHttpInfo($product_id, $option_id, $option_value, $accept, $content_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createOptionValueAsyncWithHttpInfo($product_id, $option_id, $option_value, $accept, $content_type)
    {
        $returnType = '\Swagger\Client\Model\VariantResponse';
        $request = $this->createOptionValueRequest($product_id, $option_id, $option_value, $accept, $content_type);
     ...
     */
    protected function createOptionValueRequest($product_id, $option_id, $option_value, $accept, $content_type)
    {
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\OptionValueCollectionResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\OptionValueCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Swagger\Client\Model\OptionValueCollectionResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\OptionValueCollectionResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  int $option_id The ID of the &#x60;Option&#x60;. (required)
     * @param  int $value_id The ID of the &#x60;Modifier/Option Value&#x60;. (required)
     * @param  object $option_value A BigCommerce &#x60;OptionValue&#x60; object. (required)
     * @param  string $accept accept (required)
     * @param  string $content_type content_type (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     ...
     * @return \Swagger\Client\Model\VariantResponse
     */
    public function updateOptionValue($product_id, $option_id, $value_id, $option_value, $accept, $content_type)
    {
        list($response) = $this->updateOptionValueWithHttpInfo($product_id, $option_id, $value_id, $option_value, $accept, $content_type);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\VariantResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateOptionValueWithHttpInfo($product_id, $option_id, $value_id, $option_value, $accept, $content_type)
    {
        $returnType = '\Swagger\Client\Model\VariantResponse';
        $request = $this->updateOptionValueRequest($product_id, $option_id, $value_id, $option_value, $accept, $content_type);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateOptionValueAsync($product_id, $option_id, $value_id, $option_value, $accept, $content_type)
    {
        return $this->updateOptionValueAsyncWithHttpInfo($product_id, $option_id, $value_id, $option_value, $accept, $content_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateOptionValueAsyncWithHttpInfo($product_id, $option_id, $value_id, $option_value, $accept, $content_type)
    {
        $returnType = '\Swagger\Client\Model\VariantResponse';
        $request = $this->updateOptionValueRequest($product_id, $option_id, $value_id, $option_value, $accept, $content_type);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateOptionValueRequest($product_id, $option_id, $value_id, $option_value, $accept, $content_type)
    {
        // verify the required parameter 'product_id' is set
        if ($product_id === null || (is_array($product_id) && count($product_id) === 0)) {
            throw new \InvalidArgumentException(
