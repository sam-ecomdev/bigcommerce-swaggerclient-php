...
class ProductVariantBase implements ModelInterface, ArrayAccess
{
    ...
    public function setCostPrice($cost_price)
    {
        ...
        if (!is_null($cost_price) && ($cost_price < 0)) {
            throw new \InvalidArgumentException('invalid value for $cost_price when calling ProductVariantBase., must be bigger than or equal to 0.');
        }
    ...
    public function setPrice($price)
    {
        ...
        if (!is_null($price) && ($price < 0)) {
            throw new \InvalidArgumentException('invalid value for $price when calling ProductVariantBase., must be bigger than or equal to 0.');
        }
    ...
    public function setSalePrice($sale_price)
    {
        ...
        if (!is_null($sale_price) && ($sale_price < 0)) {
            throw new \InvalidArgumentException('invalid value for $sale_price when calling ProductVariantBase., must be bigger than or equal to 0.');
        }
    ...
    public function setRetailPrice($retail_price)
    {
        ...
        if (!is_null($retail_price) && ($retail_price < 0)) {
            throw new \InvalidArgumentException('invalid value for $retail_price when calling ProductVariantBase., must be bigger than or equal to 0.');
        }
    ...
    public function setWeight($weight)
    {
        ...
        if (!is_null($weight) && ($weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling ProductVariantBase., must be bigger than or equal to 0.');
        }
    ...
    public function setWidth($width)
    {
        ...
        if (!is_null($width) && ($width < 0)) {
            throw new \InvalidArgumentException('invalid value for $width when calling ProductVariantBase., must be bigger than or equal to 0.');
        }
    ...
    public function setHeight($height)
    {
        ...
        if (!is_null($height) && ($height < 0)) {
            throw new \InvalidArgumentException('invalid value for $height when calling ProductVariantBase., must be bigger than or equal to 0.');
        }
    ...
    public function setDepth($depth)
    {
        ...
        if (!is_null($depth) && ($depth < 0)) {
            throw new \InvalidArgumentException('invalid value for $depth when calling ProductVariantBase., must be bigger than or equal to 0.');
        }
    ...
    public function setFixedCostShippingPrice($fixed_cost_shipping_price)
    {
        ...
        if (!is_null($fixed_cost_shipping_price) && ($fixed_cost_shipping_price < 0)) {
            throw new \InvalidArgumentException('invalid value for $fixed_cost_shipping_price when calling ProductVariantBase., must be bigger than or equal to 0.');
        }
    ...
    public function setPurchasingDisabledMessage($purchasing_disabled_message)
    {
        if (!is_null($purchasing_disabled_message) && (mb_strlen($purchasing_disabled_message) > 255)) {
            throw new \InvalidArgumentException('invalid length for $purchasing_disabled_message when calling ProductVariantBase., must be smaller than or equal to 255.');
        }
        if (!is_null($purchasing_disabled_message) && (mb_strlen($purchasing_disabled_message) < 0)) {
            throw new \InvalidArgumentException('invalid length for $purchasing_disabled_message when calling ProductVariantBase., must be bigger than or equal to 0.');
        }
    ...
    public function setBinPickingNumber($bin_picking_number)
    {
        if (!is_null($bin_picking_number) && (mb_strlen($bin_picking_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bin_picking_number when calling ProductVariantBase., must be smaller than or equal to 255.');
        }
        if (!is_null($bin_picking_number) && (mb_strlen($bin_picking_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bin_picking_number when calling ProductVariantBase., must be bigger than or equal to 0.');
        }
