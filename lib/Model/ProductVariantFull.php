 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductVariantFull extends ProductVariantBase 
{
    ...
    protected static $swaggerTypes = [
        ...
        'sku' => 'string',
        'sku_id' => 'int',
        'option_values' => '\Swagger\Client\Model\ProductVariantOptionValueFull[]',
     ...
     * Gets option_values
     *
     * @return \Swagger\Client\Model\ProductVariantOptionValueFull[]
     */
     ...
     * Sets option_values
     *
     * @param \Swagger\Client\Model\ProductVariantOptionValueFull[] $option_values Array of option and option values IDs that make up this variant. Will be empty if the variant is the product's base variant.
     *
     * @return $this
     */
