...
class BrandFull implements ModelInterface, ArrayAccess
{
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling BrandFull., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling BrandFull., must be bigger than or equal to 1.');
        }
    ...
    public function setPageTitle($page_title)
    {
        if (!is_null($page_title) && (mb_strlen($page_title) > 255)) {
            throw new \InvalidArgumentException('invalid length for $page_title when calling BrandFull., must be smaller than or equal to 255.');
        }
        if (!is_null($page_title) && (mb_strlen($page_title) < 0)) {
            throw new \InvalidArgumentException('invalid length for $page_title when calling BrandFull., must be bigger than or equal to 0.');
        }
    ...
    public function setMetaDescription($meta_description)
    {
        if (!is_null($meta_description) && (mb_strlen($meta_description) > 65535)) {
            throw new \InvalidArgumentException('invalid length for $meta_description when calling BrandFull., must be smaller than or equal to 65535.');
        }
        if (!is_null($meta_description) && (mb_strlen($meta_description) < 0)) {
            throw new \InvalidArgumentException('invalid length for $meta_description when calling BrandFull., must be bigger than or equal to 0.');
        }
    ...
    public function setSearchKeywords($search_keywords)
    {
        if (!is_null($search_keywords) && (mb_strlen($search_keywords) > 65535)) {
            throw new \InvalidArgumentException('invalid length for $search_keywords when calling BrandFull., must be smaller than or equal to 65535.');
        }
        if (!is_null($search_keywords) && (mb_strlen($search_keywords) < 0)) {
            throw new \InvalidArgumentException('invalid length for $search_keywords when calling BrandFull., must be bigger than or equal to 0.');
        }
