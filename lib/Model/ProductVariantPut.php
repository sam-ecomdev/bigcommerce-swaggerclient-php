 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductVariantPut extends ProductVariantBase 
{
    ...
    public function setSku($sku)
    {
        if (!is_null($sku) && (mb_strlen($sku) > 255)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling ProductVariantPut., must be smaller than or equal to 255.');
        }
        if (!is_null($sku) && (mb_strlen($sku) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling ProductVariantPut., must be bigger than or equal to 1.');
        }
