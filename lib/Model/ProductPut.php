...
class ProductPut implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'reviews_count' => 'int',
        'total_sold' => 'int',
        'custom_fields' => '\Swagger\Client\Model\ProductCustomFieldPut[]',
        'bulk_pricing_rules' => '\Swagger\Client\Model\BulkPricingRuleFull[]',
        'images' => '\Swagger\Client\Model\ProductImageFull[]',
        'videos' => '\Swagger\Client\Model\ProductVideoFull[]',
        'variants' => '\Swagger\Client\Model\ProductVariantPutProduct'
    ];
    ...
    {
        if (!is_null($product_tax_code) && (mb_strlen($product_tax_code) > 255)) {
        ...
        if (!is_null($product_tax_code) && (mb_strlen($product_tax_code) < 0)) {
    ...
    {
        if (!is_null($warranty) && (mb_strlen($warranty) > 65535)) {
        ...
        if (!is_null($warranty) && (mb_strlen($warranty) < 0)) {
    ...
    {
        if (!is_null($availability_description) && (mb_strlen($availability_description) > 255)) {
        ...
        if (!is_null($availability_description) && (mb_strlen($availability_description) < 0)) {
    ...
    {
        if (!is_null($preorder_message) && (mb_strlen($preorder_message) > 255)) {
        ...
        if (!is_null($preorder_message) && (mb_strlen($preorder_message) < 0)) {
    ...
    {
        if (!is_null($price_hidden_label) && (mb_strlen($price_hidden_label) > 200)) {
        ...
        if (!is_null($price_hidden_label) && (mb_strlen($price_hidden_label) < 0)) {
     ...
     * Gets custom_fields
     *
     * @return \Swagger\Client\Model\ProductCustomFieldPut[]
     */
     ...
     * Sets custom_fields
     *
     * @param \Swagger\Client\Model\ProductCustomFieldPut[] $custom_fields custom_fields
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\BulkPricingRuleFull[]
     */
     ...
     *
     * @param \Swagger\Client\Model\BulkPricingRuleFull[] $bulk_pricing_rules bulk_pricing_rules
     *
     * @return $this
     */
     ...
     * Gets images
     *
     * @return \Swagger\Client\Model\ProductImageFull[]
     */
     ...
     * Sets images
     *
     * @param \Swagger\Client\Model\ProductImageFull[] $images images
     *
     * @return $this
     */
     ...
     * Gets videos
     *
     * @return \Swagger\Client\Model\ProductVideoFull[]
     */
     ...
     * Sets videos
     *
     * @param \Swagger\Client\Model\ProductVideoFull[] $videos videos
     *
     * @return $this
     */
     ...
     * Gets variants
     *
     * @return \Swagger\Client\Model\ProductVariantPutProduct
     */
     ...
     * Sets variants
     *
     * @param \Swagger\Client\Model\ProductVariantPutProduct $variants variants
     *
     * @return $this
     */
