...
class ProductOptionBase implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'display_name' => 'string',
        'type' => 'string',
        'config' => '\Swagger\Client\Model\ProductOptionConfigFull',
        'sort_order' => 'int',
        'option_values' => '\Swagger\Client\Model\ProductOptionOptionValueFull'
    ];
    ...
    public function setDisplayName($display_name)
    {
        if (!is_null($display_name) && (mb_strlen($display_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling ProductOptionBase., must be smaller than or equal to 255.');
        }
        if (!is_null($display_name) && (mb_strlen($display_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling ProductOptionBase., must be bigger than or equal to 1.');
        }
     ...
     * Gets config
     *
     * @return \Swagger\Client\Model\ProductOptionConfigFull
     */
     ...
     * Sets config
     *
     * @param \Swagger\Client\Model\ProductOptionConfigFull $config config
     *
     * @return $this
     */
     ...
     * Sets option_values
     *
     * @param \Swagger\Client\Model\ProductOptionOptionValueFull $option_values option_values
     *
     * @return $this
     */
