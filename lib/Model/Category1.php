...
class Category1 implements ModelInterface, ArrayAccess
{
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Category1., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Category1., must be bigger than or equal to 1.');
        }
    ...
    public function setSortOrder($sort_order)
    {
        ...
        if (!is_null($sort_order) && ($sort_order > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $sort_order when calling Category1., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($sort_order) && ($sort_order < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $sort_order when calling Category1., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setPageTitle($page_title)
    {
        if (!is_null($page_title) && (mb_strlen($page_title) > 255)) {
            throw new \InvalidArgumentException('invalid length for $page_title when calling Category1., must be smaller than or equal to 255.');
        }
        if (!is_null($page_title) && (mb_strlen($page_title) < 0)) {
            throw new \InvalidArgumentException('invalid length for $page_title when calling Category1., must be bigger than or equal to 0.');
        }
    ...
    public function setSearchKeywords($search_keywords)
    {
        if (!is_null($search_keywords) && (mb_strlen($search_keywords) > 255)) {
            throw new \InvalidArgumentException('invalid length for $search_keywords when calling Category1., must be smaller than or equal to 255.');
        }
        if (!is_null($search_keywords) && (mb_strlen($search_keywords) < 0)) {
            throw new \InvalidArgumentException('invalid length for $search_keywords when calling Category1., must be bigger than or equal to 0.');
        }
    ...
    public function setMetaDescription($meta_description)
    {
        if (!is_null($meta_description) && (mb_strlen($meta_description) > 65535)) {
            throw new \InvalidArgumentException('invalid length for $meta_description when calling Category1., must be smaller than or equal to 65535.');
        }
        if (!is_null($meta_description) && (mb_strlen($meta_description) < 0)) {
            throw new \InvalidArgumentException('invalid length for $meta_description when calling Category1., must be bigger than or equal to 0.');
        }
    ...
    public function setLayoutFile($layout_file)
    {
        if (!is_null($layout_file) && (mb_strlen($layout_file) > 500)) {
            throw new \InvalidArgumentException('invalid length for $layout_file when calling Category1., must be smaller than or equal to 500.');
        }
        if (!is_null($layout_file) && (mb_strlen($layout_file) < 0)) {
            throw new \InvalidArgumentException('invalid length for $layout_file when calling Category1., must be bigger than or equal to 0.');
        }
