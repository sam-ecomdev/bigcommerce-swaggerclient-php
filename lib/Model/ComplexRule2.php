...
/**
 * ComplexRule2 Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ComplexRule2 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Complex Rule_2';
    ...
    public function setSortOrder($sort_order)
    {
        ...
        if (!is_null($sort_order) && ($sort_order > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $sort_order when calling ComplexRule2., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($sort_order) && ($sort_order < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $sort_order when calling ComplexRule2., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setPurchasingDisabledMessage($purchasing_disabled_message)
    {
        if (!is_null($purchasing_disabled_message) && (mb_strlen($purchasing_disabled_message) > 255)) {
            throw new \InvalidArgumentException('invalid length for $purchasing_disabled_message when calling ComplexRule2., must be smaller than or equal to 255.');
        }
        if (!is_null($purchasing_disabled_message) && (mb_strlen($purchasing_disabled_message) < 0)) {
            throw new \InvalidArgumentException('invalid length for $purchasing_disabled_message when calling ComplexRule2., must be bigger than or equal to 0.');
        }
