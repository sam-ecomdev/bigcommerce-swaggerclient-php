...
**config** | [**\Swagger\Client\Model\ProductOptionConfigFull**](ProductOptionConfigFull.md) |  | [optional] 
**sort_order** | **int** | Order in which the option is displayed on the storefront. | [optional] 
**option_values** | [**\Swagger\Client\Model\ProductOptionOptionValueFull**](ProductOptionOptionValueFull.md) |  | [optional] 
